...
for seq1 in ../00_raw_data/human_disease/hd_single/*_1.fastq.gz
do
...
for seq1 in ../02_trimmed_data/human_disease/hd_single/*_1_trimmed.fastq.gz
...
for sample in ../04_hisat2_output/human_disease/hd_single/*_s.bam;
